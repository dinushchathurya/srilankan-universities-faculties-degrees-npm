...
import { getAllDegrees, getDegreesByFaculty, Degree } from "../src/degrees";
...
describe("Degrees Module", () => {
  describe("getAllDegrees()", () => {
    it("should return all degrees with full data", () => {
      ...
      // Updated the ID here to match the data file
      const llb = degrees.find((d) => d.id === "bachelor-of-laws-colombo");
  ...
  describe("getDegreesByFaculty()", () => {
    it("should return degrees for a valid faculty in a university", () => {
      const lawDegrees = getDegreesByFaculty(
    ...
    it("should be case-insensitive", () => {
      const degrees1 = getDegreesByFaculty(
        "University of Colombo",
        "Faculty of Law"
      );
      const degrees2 = getDegreesByFaculty(
        "university of colombo",
        "faculty of law"
      );
      const degrees3 = getDegreesByFaculty(
        "UNIVERSITY OF COLOMBO",
        "FACULTY OF LAW"
      );
    ...
    it("should return empty array for invalid faculty", () => {
      const results = getDegreesByFaculty(
        "University of Colombo",
        "Invalid Faculty"
      );
  ...
  describe("Type verification", () => {
    it("should have correct types", () => {
      ...
      const degreesByFaculty: Degree[] = getDegreesByFaculty(
        "University of Colombo",
        "Faculty of Law"
      );
